...
napravo kliknete na radioaktivní ikonku <Inline>/img/output-001.jpg</Inline> nebo jednodušeji **CTRL+A**, streč zrušítě **CTRL+F12**. Dalším způsobem jak strečnout fotku je pomocí <u>Screen transfer function</u>.
...
kolem 60. Po vybrání stiskněte tlačítko <Inline>/img/output-013.jpg</Inline> a otevře se vám okno s vaší průměrnou hvězdou. Okno minimalizujte a přesuňte bokem.
...
:-------------------------:|:-------------------------:|:-------------------------:
![](/img/output-018.jpg) | ![](/img/output-019.jpg) | ![](/img/output-020.jpg)
