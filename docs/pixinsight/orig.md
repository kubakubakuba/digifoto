...
napravo kliknete na radioaktivní ikonku <img src="./img/output-001.png" style="display: inline; vertical-align: middle;"> nebo jednodušeji **CTRL+A**, streč zrušítě **CTRL+F12**. Dalším způsobem jak strečnout fotku je pomocí <u>Screen transfer function</u>.
...
kolem 60. Po vybrání stiskněte tlačítko <img src="./img/output-013.png" style="display: inline; vertical-align: middle;"> a otevře se vám okno s vaší průměrnou hvězdou. Okno minimalizujte a přesuňte bokem.
...
:-------------------------:|:-------------------------:|:-------------------------:
![](img/output-018.png) | ![](img/output-019.png) | ![](img/output-020.png)
